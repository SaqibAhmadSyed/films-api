...
class BaseModel
{
    ...
    protected function paginate(string $sql, array $filters)
    {
        ...
        //step 2) Instantiate PaginationHelper
        $paginator = new PaginationHelper($this->current_page, $this->records_per_page, $rows_count);
        ...
        //step 6) query the table to retrieve the partial result/the requested page
